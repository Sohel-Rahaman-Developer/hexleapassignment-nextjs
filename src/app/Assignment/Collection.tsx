...
const Collection: React.FC = () => {
    const allCollections: CollectionCard[] = [
        {
            id: 1,
...
const CardCollection: React.FC<CardCollectionProps> = ({ collectionCard }) => {
    ...
    return (
        <div className="w-full ">
            <div className="max-w-[257px] mx-auto relative">
                {!isDarkMode ? (
                    <img
                        src="/assets/images/collectionBack.png"
                        alt=""
                        className="h-[auto] max-w-[100%] object-cover rounded-t-sm"
                    />
                ) : (
                    <img
                        src="/assets/images/collectionBackDark.png"
                        alt=""
                ...
                <div className="absolute h-full w-full bg-[transparent] top-0 left-0 px-[14px] pt-[13px]">
                    <img
                        src={`/assets/images/${collectionCard.image}`}
                        alt=""
                        className="h-[auto] max-w-[100%] object-cover rounded-t-sm"
                    />
...
const NextArrow: React.FC<ArrowProps> = ({ className, style, onClick }) => {
    return (
        <div className={className} style={{ ...style, display: "block", cursor: "pointer" }} onClick={onClick}>
...
export { CardCollection, NextArrow, PrevArrow };
